...
class get_ServiceLocator_GxkSA7lService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.gxkSA7l'])) {
            return $container->privates['.service_locator.gxkSA7l'];
        }

        return $container->privates['.service_locator.gxkSA7l'] = $instance;
    }
}
