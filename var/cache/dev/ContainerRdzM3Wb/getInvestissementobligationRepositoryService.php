 ...
 */
class getInvestissementobligationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InvestissementobligationRepository' shared autowired service.
     *
     * @return \App\Repository\InvestissementobligationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvestissementobligationRepository.php';

        return $container->privates['App\\Repository\\InvestissementobligationRepository'] = new \App\Repository\InvestissementobligationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
