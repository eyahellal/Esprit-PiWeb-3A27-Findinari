 ...
 */
class getObligationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ObligationRepository' shared autowired service.
     *
     * @return \App\Repository\ObligationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ObligationRepository.php';

        return $container->privates['App\\Repository\\ObligationRepository'] = new \App\Repository\ObligationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
