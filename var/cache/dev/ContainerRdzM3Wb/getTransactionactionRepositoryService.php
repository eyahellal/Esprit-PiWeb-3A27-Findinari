 ...
 */
class getTransactionactionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransactionactionRepository' shared autowired service.
     *
     * @return \App\Repository\TransactionactionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransactionactionRepository.php';

        return $container->privates['App\\Repository\\TransactionactionRepository'] = new \App\Repository\TransactionactionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
