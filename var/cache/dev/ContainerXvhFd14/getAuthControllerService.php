...
class getAuthControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.G._Ouo6'] ?? $container->load('get_ServiceLocator_G_Ouo6Service'))->withContext('App\\Controller\\AuthController', $container));
