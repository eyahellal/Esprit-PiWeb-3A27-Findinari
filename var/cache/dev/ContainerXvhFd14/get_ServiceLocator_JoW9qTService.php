 ...
 */
class get_ServiceLocator_JoW9qTService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.JoW9qT_' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.JoW9qT_'])) {
            return $container->privates['.service_locator.JoW9qT_'];
        }

        return $container->privates['.service_locator.JoW9qT_'] = $instance;
    }
}
