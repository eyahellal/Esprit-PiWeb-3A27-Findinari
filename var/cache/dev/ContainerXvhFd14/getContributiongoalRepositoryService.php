 ...
 */
class getContributiongoalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContributiongoalRepository' shared autowired service.
     *
     * @return \App\Repository\ContributiongoalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContributiongoalRepository.php';

        return $container->privates['App\\Repository\\ContributiongoalRepository'] = new \App\Repository\ContributiongoalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
