...
class __TwigTemplate_d476d95a02404d96918c78f31be5279e extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Contact Us - Fin-Dinari Financial Ecosystem";
...
\t\t\t\t\t<p>Have questions about Fin-Dinari? Need help with your financial journey? We're here to support you every step of the way.</p>
\t\t\t\t</div>
\t\t\t</div>
\t\t\t<div class=\"col-lg-10\">
...
\t\t\t\t\t\t\t\t\t\t<textarea class=\"form-control shadow-none\" id=\"exampleFormControlTextarea1\" rows=\"3\" placeholder=\"Tell us about your financial goals or questions...\"></textarea>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t<li class=\"list-inline-item me-3\"><a title=\"Explorer LinkedIn Profile\" class=\"text-black\" href=\"https://linkedin.com/\"><i class=\"fab fa-linkedin-in\"></i></a>
\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
{% block title %}Contact Us - Fin-Dinari Financial Ecosystem{% endblock %}
...
\t\t\t\t\t</li>
\t\t\t\t\t<li class=\"list-inline-item\">/ &nbsp; <a href=\"{{ path('app_contact') }}\">Contact</a>
\t\t\t\t\t</li>
\t\t\t\t</ul>
\t\t\t</div>
\t\t</div>
...
{% endblock %}", "home/contact.html.twig", "C:\\Users\\GIGABYTE\\Downloads\\Esprit-PiWeb-3A27-Findinari-dev_ahmed\\Esprit-PiWeb-3A27-Findinari-dev_ahmed\\templates\\home\\contact.html.twig");
    }
}
