...
class __TwigTemplate_fda2c38d74a65511339d3ee0eb9a9d4c extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "About Fin-Dinari - Complete Personal Finance Ecosystem";
...
\t\t\t\t<h2 class=\"mb-3 text-capitalize\">About Fin-Dinari</h2>
...
\t\t\t\t\t<p class=\"text-primary text-uppercase fw-bold mb-3\">Welcome to Fin-Dinari</p>
\t\t\t\t\t<h2 class=\"h1 mb-4\">Your Complete <br>Personal Finance Ecosystem</h2>
\t\t\t\t\t<div class=\"content pe-0 pe-lg-5\">
\t\t\t\t\t\t<p>Fin-Dinari is not just another expense tracker—it's a comprehensive financial ecosystem that combines intelligent money management, investment planning, goal achievement, and social community features all in one beautiful application. Whether you're a beginner investor, a seasoned trader, or someone who wants to connect with like-minded individuals on their financial journey, Fin-Dinari provides the tools and community support you need to succeed.</p>
\t\t\t\t\t\t<p>Track income and expenses with AI-powered categorization, manage multiple wallets across Cash, Bank, Crypto, and Investments, and get real-time balance updates across all your accounts. Transform from a spender to an investor with our powerful investment tools.</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"";
        // line 56
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/about/about-11.jpg"), "html", null, true);
        yield "\" alt=\"Fin-Dinari - Complete Personal Finance Ecosystem\" class=\"rounded w-100\">
\t\t\t</div>
\t\t</div>
\t</div>
</section>
...
\t\t\t\t\t<h2>Who We Are?</h2>
\t\t\t\t</div>
\t\t\t\t<p class=\"lead\">Fin-Dinari is a financial movement that helps people understand their money, grow their wealth, and achieve their dreams with structured goals and community support.</p>
\t\t\t\t<div class=\"content\">We believe that managing finances shouldn't be a lonely journey. That's why we built an ecosystem where you can track expenses, build investment portfolios, set meaningful goals, and connect with like-minded individuals who share your financial aspirations. From living paycheck to paycheck to building wealth, we're with you every step of the way.</div>
\t\t\t</div>
\t\t\t<div class=\"col-lg-5\">
\t\t\t\t<div class=\"section-title\">
\t\t\t\t\t<p class=\"text-primary text-uppercase fw-bold mb-3\"></p>
\t\t\t\t\t<h2>What We Offer?</h2>
\t\t\t\t</div>
\t\t\t\t<p class=\"lead\">Smart money tracking, investment portfolio management, goal achievement system, social community features, AI-powered insights, and gamified experience.</p>
\t\t\t\t<div class=\"content\">
\t\t\t\t\t<ul>
\t\t\t\t\t\t<li>AI-powered expense categorization and insights</li>
\t\t\t\t\t\t<li>Multi-asset investment portfolio management</li>
\t\t\t\t\t\t<li>Dynamic goal tracking with milestone celebrations</li>
\t\t\t\t\t\t<li>Vibrant community with groups and mentorship</li>
\t\t\t\t\t\t<li>Gamification with badges, levels, and leaderboards</li>
\t\t\t\t\t</ul>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t<div class=\"icon icon-lg bg-transparent mb-4\"><i class=\"fas fa-chart-line text-primary\"></i>
\t\t\t\t</div>
\t\t\t\t<h3>Smart Tracking</h3>
\t\t\t\t<p class=\"px-lg-5\">AI-powered expense categorization with real-time balance updates</p>
\t\t\t</div>
\t\t\t<div class=\"col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item\">
\t\t\t\t<div class=\"icon icon-lg bg-transparent mb-4\"><i class=\"fas fa-chart-pie text-primary\"></i>
\t\t\t\t</div>
\t\t\t\t<h3>Investment Portfolio</h3>
\t\t\t\t<p class=\"px-lg-5\">Track stocks, crypto, real estate with ROI calculations</p>
\t\t\t</div>
\t\t\t<div class=\"col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item\">
\t\t\t\t<div class=\"icon icon-lg bg-transparent mb-4\"><i class=\"fas fa-users text-primary\"></i>
\t\t\t\t</div>
\t\t\t\t<h3>Community Support</h3>
\t\t\t\t<p class=\"px-lg-5\">Connect with like-minded people on their financial journey</p>
\t\t\t</div>
\t\t</div>
\t</div>
</section>
...
\t\t\t\t\t\t\t<p class=\"mb-0\">Smart categorization and personalized financial insights</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"icon-box-item col-md-6\">
\t\t\t\t\t\t<div class=\"block bg-white\">
\t\t\t\t\t\t\t<div class=\"icon rounded-number\">02</div>
\t\t\t\t\t\t\t<h3 class=\"mb-3\">Community Driven</h3>
\t\t\t\t\t\t\t<p class=\"mb-0\">Learn from mentors and share success with accountability partners</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"icon-box-item col-md-6\">
\t\t\t\t\t\t<div class=\"block bg-white\">
\t\t\t\t\t\t\t<div class=\"icon rounded-number\">03</div>
\t\t\t\t\t\t\t<h3 class=\"mb-3\">Goal Oriented</h3>
\t\t\t\t\t\t\t<p class=\"mb-0\">Turn dreams into reality with structured goal tracking</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"icon-box-item col-md-6\">
\t\t\t\t\t\t<div class=\"block bg-white\">
...
\t\t\t\t\t\t\t<p class=\"mb-0\">Earn badges, level up, and compete on leaderboards</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"has-shapes\">
...
\t\t\t\t\t<div class=\"content\">
\t\t\t\t\t\t<p>At Fin-Dinari, we believe that financial success should be accessible to everyone. That's why we've built a platform that combines powerful tools with a supportive community to help you achieve your financial goals.</p>
\t\t\t\t\t\t<p>From AI-powered expense tracking to comprehensive investment portfolio management, from structured goal achievement to gamified motivation - Fin-Dinari is your all-in-one financial ecosystem. Join thousands of users who have transformed their financial lives with our platform and community.</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t\t<h1>What Our Users Achieve</h1>
\t\t\t\t\t<p class=\"mb-0\">Real people, real results with Fin-Dinari. Join our community and<br>start your financial journey today.</p>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"";
        // line 240
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/about/team-1.jpg"), "html", null, true);
        yield "\" alt=\"Ahmed Benali\" class=\"rounded w-100\" width=\"300\" height=\"332\">
...
\t\t\t\t\t<div class=\"card-body\">
\t\t\t\t\t\t<h3>Ahmed Benali</h3>
\t\t\t\t\t\t<p>\"From paycheck to paycheck to \$50K portfolio in 18 months. The community kept me motivated!\"</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t\t<div class=\"col-xl-3 col-lg-4 col-md-6 mt-4\">
...
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"";
        // line 259
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/about/team-2.jpg"), "html", null, true);
        yield "\" alt=\"Sofia Mansouri\" class=\"rounded w-100\" width=\"300\" height=\"333\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"card-body\">
\t\t\t\t\t\t<h3>Sofia Mansouri</h3>
\t\t\t\t\t\t<p>\"Goal-setting helped me save for my dream wedding. Reached my target 3 months early!\"</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t\t<div class=\"col-xl-3 col-lg-4 col-md-6 mt-4\">
...
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"";
        // line 278
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/about/team-3.jpg"), "html", null, true);
        yield "\" alt=\"Mehdi Khemiri\" class=\"rounded w-100\" width=\"300\" height=\"333\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
\t\t\t\t\t<div class=\"card-body\">
\t\t\t\t\t\t<h3>Mehdi Khemiri</h3>
\t\t\t\t\t\t<p>\"Learned about crypto from the community and turned \$500 into \$3000. Best decision ever!\"</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t\t<div class=\"col-xl-3 col-lg-4 col-md-6 mt-4\">
...
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"";
        // line 297
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/about/team-1.jpg"), "html", null, true);
        yield "\" alt=\"Leila Toumi\" class=\"rounded w-100\" width=\"300\" height=\"332\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
\t\t\t\t\t<div class=\"card-body\">
\t\t\t\t\t\t<h3>Leila Toumi</h3>
\t\t\t\t\t\t<p>\"Accountability partner system changed my life. Someone was counting on me to save!\"</p>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
";
    ...
    {
        return array (  411 => 297,  389 => 278,  367 => 259,  345 => 240,  158 => 56,  114 => 15,  109 => 13,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}About Fin-Dinari - Complete Personal Finance Ecosystem{% endblock %}
...
\t\t\t\t\t</li>
\t\t\t\t\t<li class=\"list-inline-item\">/ &nbsp; <a href=\"{{ path('app_about') }}\">About</a>
\t\t\t\t\t</li>
\t\t\t\t</ul>
\t\t\t</div>
\t\t</div>
...
\t\t\t</div>
\t\t\t<div class=\"col-lg-4 mt-5 mt-lg-0\">
\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"{{ asset('images/about/about-11.jpg') }}\" alt=\"Fin-Dinari - Complete Personal Finance Ecosystem\" class=\"rounded w-100\">
\t\t\t</div>
\t\t</div>
\t</div>
</section>
...
\t\t\t\t<div class=\"card bg-transparent border-0 text-center\">
\t\t\t\t\t<div class=\"card-img\">
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"{{ asset('images/about/team-1.jpg') }}\" alt=\"Ahmed Benali\" class=\"rounded w-100\" width=\"300\" height=\"332\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
\t\t\t\t<div class=\"card bg-transparent border-0 text-center\">
\t\t\t\t\t<div class=\"card-img\">
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"{{ asset('images/about/team-2.jpg') }}\" alt=\"Sofia Mansouri\" class=\"rounded w-100\" width=\"300\" height=\"333\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
\t\t\t\t<div class=\"card bg-transparent border-0 text-center\">
\t\t\t\t\t<div class=\"card-img\">
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"{{ asset('images/about/team-3.jpg') }}\" alt=\"Mehdi Khemiri\" class=\"rounded w-100\" width=\"300\" height=\"333\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
\t\t\t\t<div class=\"card bg-transparent border-0 text-center\">
\t\t\t\t\t<div class=\"card-img\">
\t\t\t\t\t\t<img loading=\"lazy\" decoding=\"async\" src=\"{{ asset('images/about/team-1.jpg') }}\" alt=\"Leila Toumi\" class=\"rounded w-100\" width=\"300\" height=\"332\">
\t\t\t\t\t\t<ul class=\"card-social list-inline\">
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"facebook\" href=\"#\"><i class=\"fab fa-facebook\"></i></a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"list-inline-item\"><a class=\"twitter\" href=\"#\"><i class=\"fab fa-twitter\"></i></a>
...
{% endblock %}", "home/about.html.twig", "C:\\Users\\GIGABYTE\\Downloads\\Esprit-PiWeb-3A27-Findinari-dev_ahmed\\Esprit-PiWeb-3A27-Findinari-dev_ahmed\\templates\\home\\about.html.twig");
    }
}
