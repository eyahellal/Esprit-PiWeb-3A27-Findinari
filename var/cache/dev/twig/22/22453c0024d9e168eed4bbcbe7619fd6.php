...
class __TwigTemplate_9876e0b69c1c9800e031f3d57cf70d29 extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Our Services - Fin-Dinari Complete Financial Ecosystem";
...
\t\t<div class=\"icon-box-item text-center col-lg-4 col-md-6 mb-4\">
    \t\t<div class=\"rounded shadow py-5 px-4\">
        ...
        <p class=\"mb-4\">Track your income and expenses with AI-powered categorization. Real-time balance updates across all accounts.</p>
        <a class=\"btn btn-sm btn-outline-primary\" href=\"";
        // line 53
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_dashboard");
        yield "\">View Details <i class=\"las la-arrow-right ms-1\"></i></a>
    </div>
</div>
...
\t\t\t<div class=\"icon-box-item text-center col-lg-4 col-md-6 mb-4\">
    \t\t\t<div class=\"rounded shadow py-5 px-4\">
        ...
        \t</div>
        \t<h3 class=\"mb-3\">Loan Investment</h3>
        \t<p class=\"mb-4\">Lend money, generate digital receipts, and earn returns after a fixed period.</p>
        \t<a class=\"btn btn-sm btn-outline-primary\" href=\"";
        // line 64
...
\t\t\t
\t\t\t<!-- ============================================================ -->
\t\t\t<!-- Service 3: Objective Management — LIEN MODIFIÉ → objectif_index -->
\t\t\t<!-- ============================================================ -->
\t\t\t<div class=\"icon-box-item text-center col-lg-4 col-md-6 mb-4\">
\t\t\t\t<div class=\"rounded shadow py-5 px-4\">
\t\t\t\t\t<div class=\"icon\"> <i class=\"fas fa-bullseye\"></i>
\t\t\t\t\t</div>
\t\t\t\t\t<h3 class=\"mb-3\">Objective Management</h3>
\t\t\t\t\t<p class=\"mb-4\">Set financial goals - short, medium, or long term. Track progress with visual analytics, get AI-powered savings suggestions, and celebrate milestones.</p>
\t\t\t\t\t";
        // line 78
        ...
        yield "\">
\t\t\t\t\t\tGérer mes objectifs <i class=\"las la-arrow-right ms-1\"></i>
\t\t\t\t\t</a>
\t\t\t\t</div>
\t\t\t</div>
\t\t\t
...
\t\t\t\t\t<p class=\"mb-4\">Connect with like-minded investors, learn from billionaires and successful traders, share insights, and grow your financial knowledge together.</p>
<a class=\"btn btn-sm btn-outline-primary\" href=\"";
        // line 91
...
";
    ...
    {
        return array (  202 => 91,  185 => 78,  169 => 64,  155 => 53,  114 => 15,  109 => 13,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Our Services - Fin-Dinari Complete Financial Ecosystem{% endblock %}
...
\t\t<div class=\"icon-box-item text-center col-lg-4 col-md-6 mb-4\">
    \t\t<div class=\"rounded shadow py-5 px-4\">
        ...
        <h3 class=\"mb-3\">Budget Management</h3>
        <p class=\"mb-4\">Track your income and expenses with AI-powered categorization. Real-time balance updates across all accounts.</p>
        <a class=\"btn btn-sm btn-outline-primary\" href=\"{{ path('app_dashboard') }}\">View Details <i class=\"las la-arrow-right ms-1\"></i></a>
    </div>
</div>
...
\t\t\t<div class=\"icon-box-item text-center col-lg-4 col-md-6 mb-4\">
    \t\t\t<div class=\"rounded shadow py-5 px-4\">
        ...
        \t<h3 class=\"mb-3\">Loan Investment</h3>
        \t<p class=\"mb-4\">Lend money, generate digital receipts, and earn returns after a fixed period.</p>
        \t<a class=\"btn btn-sm btn-outline-primary\" href=\"{{ path('app_obligation_index') }}\">View Details <i class=\"las la-arrow-right ms-1\"></i></a>
    \t\t</div>
\t\t\t</div>
\t\t\t
\t\t\t<!-- ============================================================ -->
...
\t\t\t\t\t<h3 class=\"mb-3\">Objective Management</h3>
\t\t\t\t\t<p class=\"mb-4\">Set financial goals - short, medium, or long term. Track progress with visual analytics, get AI-powered savings suggestions, and celebrate milestones.</p>
\t\t\t\t\t{# ← MODIFIÉ : pointe vers le CRUD Objectif au lieu de app_service_details #}
\t\t\t\t\t<a class=\"btn btn-sm btn-outline-primary\" href=\"{{ path('objectif_index') }}\">
\t\t\t\t\t\tGérer mes objectifs <i class=\"las la-arrow-right ms-1\"></i>
\t\t\t\t\t</a>
\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t\t<h3 class=\"mb-3\">Community</h3>
\t\t\t\t\t<p class=\"mb-4\">Connect with like-minded investors, learn from billionaires and successful traders, share insights, and grow your financial knowledge together.</p>
<a class=\"btn btn-sm btn-outline-primary\" href=\"{{ path('app_service_details', {'id': 4}) }}\">View Details <i class=\"las la-arrow-right ms-1\"></i></a>
\t\t</div>
\t</div>
</section>

{% endblock %}", "home/services.html.twig", "C:\\Users\\GIGABYTE\\Downloads\\Esprit-PiWeb-3A27-Findinari-dev_ahmed\\Esprit-PiWeb-3A27-Findinari-dev_ahmed\\templates\\home\\services.html.twig");
    }
}
