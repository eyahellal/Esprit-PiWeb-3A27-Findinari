...
class __TwigTemplate_c7a27f8395871dc3148ea536444492eb extends Template
{
    ...
    <nav class=\"navbar navbar-expand-xl navbar-light text-center py-3\">
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 51, $this->source); })()), "user", [], "any", false, false, false, 51)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 52
            yield "                        ";
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 52, $this->source); })()), "user", [], "any", false, false, false, 52), "role", [], "any", false, false, false, 52) == "ADMIN")) {
                // line 53
                yield "                            <a href=\"";
                        ...
                        <div class=\"notification-wrapper\">
                            <div class=\"notification-bell\" id=\"notificationBell\">
                                <div class=\"bell-ring\">
                                    ...
                                    <span id=\"notificationBadge\" class=\"bell-badge\">0</span>
                                </div>
                            </div>
                            <div class=\"notification-popup\" id=\"notificationPopup\">
                                <div class=\"notification-header\">
                                    ...
                                    <div class=\"notification-actions\">
                                        <button class=\"notif-btn\" onclick=\"markAllNotificationsRead()\" title=\"Mark all as read\">
                                            <i class=\"fas fa-check-double\"></i>
                                        </button>
                                        <button class=\"notif-btn\" onclick=\"deleteAllNotifications()\" title=\"Delete all\">
                                ...
                                <div class=\"notification-footer\">
                                    <a href=\"#\" onclick=\"loadNotifications(); return false;\" class=\"refresh-btn\">
...
<style>
    ...
    .bell-ring {
        ...
        width: 40px;
        height: 40px;
        background: linear-gradient(145deg, #2d6a4f 0%, #1b4d3b 100%);
        border-radius: 50%;
        display: flex;
        align-items: center;
    ...
    .bell-ring:hover {
        ...
        background: linear-gradient(145deg, #1b4d3b 0%, #143d2e 100%);
    }
...
<script>
    var notificationCheckInterval = window.notificationCheckInterval || null;
                ...
                <div class=\"notification-item \${unreadClass}\" data-id=\"\${notif.id}\">
                    <div class=\"d-flex gap-3 align-items-start\">
                        <div class=\"notification-icon\">
                            <i class=\"\${icon === '✅' ? 'fas fa-check' : icon === '❌' ? 'fas fa-times' : icon === '⚠️' ? 'fas fa-exclamation-triangle' : 'fas fa-chart-line'}\"></i>
                        </div>
                        <div class=\"notification-content flex-grow-1\">
                            <div class=\"notification-title\">\${escapeHtml(notif.title)}</div>
                            <div class=\"notification-message\">\${escapeHtml(notif.message)}</div>
                            <div class=\"notification-time\">
                                <i class=\"far fa-clock me-1\"></i>\${getTimeAgo(notif.createdAt)}
                            </div>
                        </div>
                        <div class=\"notification-actions-dropdown\">
                            \${!notif.isRead ? `
                                <button class=\"action-btn read\" onclick=\"markNotificationRead('\${notif.id}')\" title=\"Mark as read\">
    ...
    document.addEventListener('turbo:load', function() {
        ...
        checkUnreadCount();
        window.notificationCheckInterval = setInterval(checkUnreadCount, 30000);
    });
    ...
    {
        return array (  234 => 111,  227 => 107,  220 => 104,  174 => 61,  168 => 58,  165 => 57,  157 => 53,  154 => 52,  152 => 51,  145 => 46,  140 => 44,  136 => 43,  131 => 42,  129 => 41,  124 => 39,  120 => 38,  116 => 37,  112 => 36,  108 => 35,  100 => 30,  94 => 27,  88 => 24,  82 => 21,  76 => 18,  70 => 15,  57 => 5,  53 => 4,  48 => 1,);
    }
                ...
                <ul class=\"navbar-nav mx-auto mb-2 mb-lg-0\">
                    ...
                    <li class=\"nav-item dropdown\"> 
                        ...
                        <ul class=\"dropdown-menu\" aria-labelledby=\"navbarDropdown\">
                            ...
                            <li><a class=\"dropdown-item\" href=\"{{ path('app_crypto_prices') }}\">Crypto Prices</a></li>
                            <li><a class=\"dropdown-item\" href=\"{{ path('app_financial_news') }}\">Financial News</a></li>
                            <li><a class=\"dropdown-item\" href=\"{{ path('app_financial_health') }}\">Financial Health</a></li>
                            <li><a class=\"dropdown-item\" href=\"{{ path('app_statistics') }}\">Statistics</a></li>
                ...
                <div class=\"d-flex align-items-center gap-3\">
                    {% if app.user %}
                        {% if app.user.role == 'ADMIN' %}
                            <a href=\"{{ path('app_admin_dashboard') }}\" class=\"btn btn-warning btn-sm\">
                                <i class=\"fas fa-shield-alt me-1\"></i>Admin
                            </a>
                        {% endif %}

                        <a href=\"{{ path('app_profile') }}\" class=\"btn btn-outline-primary btn-sm\">
                            <i class=\"fas fa-user me-1\"></i>Profile
                        </a>
                        <a href=\"{{ path('app_logout') }}\" class=\"btn btn-primary btn-sm\">
                            <i class=\"fas fa-sign-out-alt me-1\"></i>Logout
                        </a>
                    ...
                    {% else %}
                        <a href=\"{{ path('app_front_login') }}\" class=\"btn btn-outline-primary btn-sm\">
                            <i class=\"fas fa-sign-in-alt me-1\"></i>Log In
                        </a>
                        <a href=\"{{ path('app_front_register') }}\" class=\"btn btn-primary btn-sm\">
                            <i class=\"fas fa-user-plus me-1\"></i>Sign Up
                        </a>
                    {% endif %}
                </div>
...
</script>", "partials/_header.html.twig", "C:\\projects\\whatever\\Esprit-PiWeb-3A27-Findinari\\templates\\partials\\_header.html.twig");
    }
}
