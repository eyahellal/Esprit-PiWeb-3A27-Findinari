...
class __TwigTemplate_6d6c471e7b98972a4ad2f0aa7a66c9d2 extends Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 109
            yield "    <div class=\"rounded-4 p-3 mb-4 d-flex align-items-start gap-3\"
         style=\"background: #fde8e8; border-left: 4px solid #c0392b;\">
        <i class=\"fas fa-times-circle fa-lg\" style=\"color: #c0392b; margin-top: 2px;\"></i>
        <div>
            <h6 class=\"fw-bold mb-1\" style=\"color: #c0392b;\">Budget Blocked!</h6>
            <p class=\"mb-0 small\" style=\"color: #c0392b;\">";
            // line 114
...
";
        ...
        if (array_key_exists("errors", $context)) {
            ...
            yield "                                            ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 135, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                // line 136
                yield "                                                ";
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["error"], "propertyPath", [], "any", false, false, false, 136) == "montantMax")) {
                    // line 137
        ...
        if (array_key_exists("errors", $context)) {
            ...
            yield "    ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 160, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                // line 161
                yield "        ";
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["error"], "propertyPath", [], "any", false, false, false, 161) == "dureeBudget")) {
                    // line 162
                    yield "            <div class=\"text-danger small mt-1\">";
        ...
        if (array_key_exists("errors", $context)) {
            ...
            yield "    ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 184, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                // line 185
                yield "        ";
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["error"], "propertyPath", [], "any", false, false, false, 185) == "dateBudget")) {
                    // line 186
                    yield "            <div class=\"text-danger small mt-1\">";
...
";
    ...
    {
        return array (  403 => 196,  395 => 190,  388 => 188,  382 => 186,  379 => 185,  374 => 184,  372 => 183,  366 => 180,  355 => 171,  349 => 166,  342 => 164,  336 => 162,  333 => 161,  328 => 160,  326 => 159,  311 => 146,  305 => 141,  302 => 140,  296 => 139,  290 => 137,  287 => 136,  282 => 135,  280 => 134,  266 => 123,  262 => 121,  256 => 118,  246 => 114,  239 => 109,  235 => 108,  228 => 104,  224 => 103,  220 => 102,  211 => 96,  206 => 94,  197 => 87,  193 => 84,  185 => 78,  174 => 70,  171 => 69,  164 => 63,  150 => 50,  146 => 47,  136 => 38,  132 => 35,  122 => 26,  116 => 21,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% for message in app.flashes('error') %}
    <div class=\"rounded-4 p-3 mb-4 d-flex align-items-start gap-3\"
        ...
        <div>
            <h6 class=\"fw-bold mb-1\" style=\"color: #c0392b;\">Budget Blocked!</h6>
            <p class=\"mb-0 small\" style=\"color: #c0392b;\">{{ message }}</p>
        </div>
    </div>
{% endfor %}
                        <form method=\"post\" action=\"{{ path('app_budget_new_step3') }}\" novalidate>
...
{% endblock %}", "management/budget/step3.html.twig", "C:\\projects\\whatever\\Esprit-PiWeb-3A27-Findinari\\templates\\management\\budget\\step3.html.twig");
    }
}
