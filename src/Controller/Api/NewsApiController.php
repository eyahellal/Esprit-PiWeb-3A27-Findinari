...
class NewsApiController extends AbstractController
{
    ...
    public function getAllNews(Request $request): JsonResponse
    {
        ...
        $encodedSearch = urlencode((string)$search);
        $url = $this->newsApiUrl . '/everything?q=' . $encodedSearch . '&language=en&sortBy=publishedAt&apiKey=' . $this->newsApiKey;
    ...
    public function searchNews(Request $request): JsonResponse
    {
        ...
        $encodedQuery = urlencode((string)$query);
        $url = $this->newsApiUrl . '/everything?q=' . $encodedQuery . '&language=en&sortBy=relevancy&apiKey=' . $this->newsApiKey;
