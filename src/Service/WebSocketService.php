...
class WebSocketService
{
    ...
    public function sendMessage(int $ticketId, string $content, ?string $fileUrl = 'null'): void
    {
        $fileUrl = $fileUrl ?? 'null';
        $payload = "$ticketId|$content|$fileUrl";
        ...
        try {
            ...
            fwrite($sp, $header);
            fread($sp, 2000); // Read response (101 Switching Protocols)
