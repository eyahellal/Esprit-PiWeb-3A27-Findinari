...
class InvestmentValidatorService
{
     ...
     */
    public function validate(Investissementobligation $investment, $wallet, ?Obligation $obligation): bool
    {
        // Vérifier le type du wallet
        if ($wallet !== null && !($wallet instanceof Wallet)) {
            throw new InvalidArgumentException('Type de wallet invalide: ' . get_class($wallet));
        }
        
        // Règle 1: Le wallet doit exister
        if ($wallet === null) {
